...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        double min = Double.parseDouble ( inputString );

        int roundMin = (int) Math.floor(min);

        if (roundMin%5 ==0 || (roundMin-1)%5 ==0 ||(roundMin-2)%5 ==0) {
            System.out.println("зеленый");
        } else if ( (roundMin-3)%5 ==0 ) {
            System.out.println("желтый");
        } else if ((roundMin-4)%5 ==0) {
