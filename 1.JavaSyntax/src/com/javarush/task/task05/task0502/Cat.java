...
public class Cat {
    ...
    public boolean fight(Cat anotherCat) {
        int resultThisCat=0, resultAnotherCat=0;
        resultThisCat = this.age+this.strength+this.weight;
        resultAnotherCat = anotherCat.age+anotherCat.strength+anotherCat.weight;

        if (this.strength>anotherCat.strength) { return true;}
        else if (this.age > anotherCat.age) {return true;}
