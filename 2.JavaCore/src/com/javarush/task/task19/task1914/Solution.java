...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        //String[] parsedExpression = result.split("[0-9]");
        System.setOut(consoleStream);
        int a = Integer.parseInt(parsedString[0].trim());
        int b = Integer.parseInt(parsedString[2].trim());

        switch (parsedString[1].trim()){
            case "+":
