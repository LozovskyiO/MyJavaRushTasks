...
public class Solution {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Person p = new Person("Alex", "Loz", "Ukraine", Sex.MALE);
        ...
        Person lP = (Person) ois.readObject();
        System.out.println(lP.country + " " + lP.firstName + " " + lP.fullName + " " + lP.greeting + " " +lP.lastName + " " + lP.logger + " " + lP.sex);
