    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
            ...
            if (enteredString.contains(".")){
             try {
                print(Double.parseDouble(enteredString));
            } catch (NumberFormatException e) {
                print(enteredString);
                }
            } else if (enteredString.matches("[0-9]+")||enteredString.contains("-")&&!enteredString.contains(".")){

                int i = 0;
                try {
                    i = Integer.parseInt(enteredString);
